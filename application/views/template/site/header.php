        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mega-nav-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!--   <li class="dn"><a class="<?php //if(isset($activemenu) && $activemenu == "search_institute") echo 'active'; ?>" href="<?php //echo URL_HOME_SEARCH_INSTITUTE;?>"> <?php //echo get_languageword('Find Institute');?> </a></li> -->
