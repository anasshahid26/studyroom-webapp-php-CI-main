        ...
        <div class="row row-margin">
            ...
            <div class="col-lg-<?php echo $col_size;?> col-md-12 col-sm-12">
                <div class="row">
                    ...
                    <?php
                            $locations = $this->home_model->get_categories(array('child' => true, 'limit' => 7));
                            if(!empty($locations)) {
                    ?>
                    <div class="col-sm-3">
                        ...
                        <ul class="footer-links">
                            ...
                            <li title="<?php echo $row->name; ?>"><a href="<?php echo URL_HOME_SEARCH_TUTOR.'/by-location/'.$row->slug; ?>"> <?php echo $row->name; ?> </a></li>
                            <?php } ?>
                        </ul>
                    </div>
                    <?php } ?>
        ...
        <div class="row footer-copy-bar">
            <div class="col-md-12">
                ...
                <span class="copy-right pull-right">
                    <?php
                            echo "<strong>".get_languageword('Powered_By')."</strong> ";
                            if(isset($this->config->item('site_settings')->url_designed_by) && $this->config->item('site_settings')->url_designed_by != '')
                                ...
                                echo $this->config->item('site_settings')->Powered_By;
                    ?> &nbsp; &nbsp;
