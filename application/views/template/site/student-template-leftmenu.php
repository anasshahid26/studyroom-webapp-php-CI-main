<div class="panel-group dashboard-menu" id="accordion">
    ...
    <div class="dashboard-menu-panel">
        ...
        <div class="dashboard-link"><a <?php if(isset($activemenu) && $activemenu == 'online_session') echo 'class="active"';?> href="<?php echo URL_STUDENT_ONLINE_SESSION; ?>"><i class="fa fa-circle"></i>Online Session</a></div>
