<?php
$this->load->view('template/site/header', $grocery_output); ?>
<?php var_dump($user_idd['is_certificates']); ?>
<?php var_dump($user_idd['is_interview']); ?>
            ...
            <div class="container">
                <div class="row offcanvas offcanvas-right row-margin">
                    ...
                    <div class="col-xs-12 col-sm-8 dashboard-content ">
                        ...
                        <?php $this->load->view('template/site/t_button.php'); ?>
                        <!-- breadcrumb ends -->
                        <?php
