<ul class="sidebar-menu">
	...
	<li <?php if(isset($activemenu) && $activemenu == 'dashboard') echo ' class="active"';?>>
		...
		<ul class='treeview-menu'>
			...
			<li class="dn" <?php if(isset($activesubmenu) && $activesubmenu == 'inst_batches') echo ' class="active"';?>>
		...
		<ul class='treeview-menu'>
			...
			<li class="dn" <?php if(isset($activesubmenu) && $activesubmenu == '4') echo ' class="active"';?>>
	...
	<li  class='dn treeview <?php if(isset($activemenu) && $activemenu == 'inst_money_reqs') echo 'active';?>'>
		<a href='#'>
