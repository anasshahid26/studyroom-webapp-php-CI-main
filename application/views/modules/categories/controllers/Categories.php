...
class Categories extends MY_Controller 
{
	...
	function courses()
	{
		...
		$crud->columns('name','code', 'credit', 'slug', 'is_popular', 'status');
		$crud->add_fields(array('categories','name', 'credit', 'slug', 'description', 'code', 'sort_order', 'image', 'is_popular', 'status', 'is_parent'));
