                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="user-profile-pic">
                            ...
                            <?php } elseif ($row->gender == "Female"){?>
                                <img src="<?php echo base_url();?>assets/uploads/profiles/default-tutor-female.png">
                                <?php
                            } elseif($profile->gender=="Male" && $row->gender == "Female"){?>
                                <img src="<?php echo base_url();?>assets/uploads/profiles/default-tutor-female.png">
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    <?php 
                                        ...
                                        foreach($payment_gateways as $gateway)
                                        {
                                            ...
                                            <div class="col-lg-4 col-md-4 ">
                                                <div class=" radio">
                                                    <label><?php
                                                     //   print_r($gateway);?>
                                                        <input type="radio" name="gateway_id" value="<?php echo $gateway->type_title;?>">
						...
						<i class="fa check fa-dot-circle-o" aria-hidden="true"></i>
                                 ...
                                 //  echo form_open('payment/get_additional_content');
                                 //     echo form_open (student/list_packages/$get_additional_content);
                                    ?>
                    ...
                    <?php echo form_close(); ?>
                    <?php } else {
                        echo "Sorry! You can't reserve this teacher because Gender doesn't match.!";
                    }?>
                </div>
            </div>
