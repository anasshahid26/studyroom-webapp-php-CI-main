...
<form>
                    <button class="btn-link-dark dash-btn" name="Submit" type="Submit" formaction="certificates"><?php echo get_languageword('CERTIFICATES');?></button>
</form>
            <form>
    <button class="btn-link-dark dash-btn" name="Submit" type="Submit" formaction="interview"><?php echo get_languageword('INTERVIEW');?></button>
            </form>
